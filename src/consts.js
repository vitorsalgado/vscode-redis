...
LPUSH > Adds the value to the head of the list \n
LPUSHX > Adds the value to the head of the list as long as the list exists \n
RPUSH > Adds the value to the tail of the list \n
RPUSHX > Adds the value to the tail of the list as long as the list exists \n
...
LPOP > returns and removes the element at the head of list \n
RPOP > returns and removes the element at the tail of list \n
LSET > sets the element at the index in the list with the given value \n
LTRIM > removes the elements from the list out side the given range \n
`;